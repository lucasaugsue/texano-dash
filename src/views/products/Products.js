											...
											<Grid item xs={12} sm={12} md={8}> 
												{
													...
													?<Typography gutterBottom style={{fontSize: 16, color: 'black'}}>Nenhuma categoria</Typography>
													: item.product_category.map((p, index) => {
														if(index == (item.product_category.length - 1)){
															return(
																<Typography gutterBottom style={{fontSize: 16, color: 'black'}}>

...
const Accesses= React.lazy(() => import('./views/configs/Accesses'));
...
const routes = [
    ...
    { exact: true, path: '/configuracoes/acessos', name: 'Accesses', component: Accesses, paths: ['/configuracoes/acessos'] },
